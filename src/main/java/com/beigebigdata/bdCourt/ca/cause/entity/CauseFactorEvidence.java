 ...
 * @ClassName: CauseFactorEvidence
 * @Description: 罪种要素与证据关系
 * @date 16/10/21
 */
@Table(name = "spc_cause_fctr_evid")
public class CauseFactorEvidence extends BaseEntity {
    /**
     * ID
     */
    @Id
