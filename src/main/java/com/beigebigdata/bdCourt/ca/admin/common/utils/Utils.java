...
public class Utils {
    ...
    public static String replaceStrHtml2(String inStr) {
        String result = inStr;
        if (result != null && !"".equals(result)) {
            result = result.replaceAll("\r\n", ",");
            result = result.replaceAll("\r\n\t", ",");
...
//	// 关键字查看
//	public static boolean includeFilterWord(String message) {
//		List<String> filterList = PubXMLConfig.getInstance().listPubXmlConfigByKeyword();
...
//	}
//	//返回关键字信息
//	public static String includeFilterWord2(String message) {
//		String str ="";
//		List<String> filterList = PubXMLConfig.getInstance().listPubXmlConfigByKeyword();
//		for (String filter : filterList) {
//			if (message.indexOf(filter) > -1) {
...
//	}
    ...
    public static String getStrToHtml(String str,Integer len){
        String content="";
        if(str!=null && str.length()>len){
            content=content+str.substring(0,len)+"...";
        }else{
            content=str;
        }
    ...
    public static String getSubString(String str,Integer len){
        String content="";
        if(str!=null && str.length()>len){
            content=content+str.substring(0,len);
        }else{
