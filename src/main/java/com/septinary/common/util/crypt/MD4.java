 ...
 * 非对称加密
 * 
 * @Filename: com.septinary.common.util.MD4.java of the project [com.septinary.common]
 * @Type: MD4
 * @Desc: TODO
 * @Author: macbook[weide<weide001@gmail.com>]
 * @Created: 2016年3月22日下午5:46:34
 *
 */
public class MD4 implements IEncryptable<String> {
	...
	public String encrypt(String source, HashMap<Object, Object> options) {
        ...
        String tmp = toHexString(mdfour(buffer));
        //密文字符串
