...
public class GUIDUtil {
	...
	public String toString() {
		 ...
		 * sb.append(raw.substring(8, 12)); sb.append("-");
	...
	public static void main(String args[]) throws Exception {
		...
		System.out.println(myGUID.toString());
		/*
		 * Thread.sleep(10000); for (int i = 0; i < 1000; i++) { RandomGUID
		 * myGUID = new RandomGUID(); // System.out.println("Seeding String=" +
